...
const u8 *const gBattleStringsTable[BATTLESTRINGS_COUNT] =
{
    ...
    [STRINGID_BERRYDMGREDUCES]                      = COMPOUND_STRING("The {B_LAST_ITEM} weakened the damage to {B_SCR_ACTIVE_NAME_WITH_PREFIX2}!"),
    ...
    [STRINGID_SCR_PKMNPROTECTEDITSELF]              = COMPOUND_STRING("{B_SCR_ACTIVE_NAME_WITH_PREFIX2} protected itself!"),
    [STRINGID_SCR_PKMNAVOIDEDATTACK]                = COMPOUND_STRING("{B_SCR_ACTIVE_NAME_WITH_PREFIX2} avoided the attack!"),
    [STRINGID_SCR_ITDOESNTAFFECT]                   = COMPOUND_STRING("It doesn't affect {B_SCR_ACTIVE_NAME_WITH_PREFIX2}…"),
...
const u16 gScrMissStringIds[] =
{
    [B_MSG_SCR_MISSED]             = STRINGID_ATTACKMISSED,
    [B_MSG_SCR_PROTECTED]          = STRINGID_SCR_PKMNPROTECTEDITSELF,
    [B_MSG_SCR_AVOIDED_ATK]        = STRINGID_SCR_PKMNAVOIDEDATTACK,
    [B_MSG_SCR_FAILED]             = STRINGID_BUTITFAILED,
    [B_MSG_SCR_ITDOESNTEFFECT]     = STRINGID_SCR_ITDOESNTAFFECT,
};

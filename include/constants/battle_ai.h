...
#define AI_FLAG_HP_AWARE              (1 << 7)
#define AI_FLAG_POWERFUL_STATUS       (1 << 8)   // AI prefers moves that set up field effects or side statuses, even if the user can faint the target
